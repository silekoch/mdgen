# Modified from PyEMMA's plot_feature_histograms to remove the dependency on PyEMMA
...
def plot_feature_histograms(xyzall,
    ...
    feature_labels : iterable of str, optional, default=None
    ...
    **kwargs: kwargs passed to pyplot.fill_between. See the doc of pyplot for options.
    ...
    if feature_labels is not None:
        if not isinstance(feature_labels, list):
             raise ValueError('feature_labels must be a list of feature labels or None.')
